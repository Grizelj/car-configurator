...
const Paint: React.FC = ({}) => {
  ...
  return (
    <div>
      ...
      {car === "AUDI E-TRON GT" && interior === "Black-1" && carousel === 1 && (
        <img
          className="carouselImg"
          src="/Assets2/Car=e-tron, Color=Black, View=Seats.png"
        />
      )}
      {car === "AUDI E-TRON GT" && interior === "Black-1" && carousel === 2 && (
        <img
          className="carouselImg"
      ...
      {car === "AUDI RS5" && interior === "Lunar Silver" && carousel === 1 && (
        <img
          className="carouselImg"
          src="/Assets2/Car=RS5, Color=Lunar Silver, View=Seats.png"
        />
      )}
      {car === "AUDI RS5" && interior === "Lunar Silver" && carousel === 2 && (
        <img
          className="carouselImg"
